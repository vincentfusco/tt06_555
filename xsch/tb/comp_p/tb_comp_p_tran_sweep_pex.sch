...
C {devices/vsource.sym} -190 250 0 0 {name=VCOMP_N value=1.2 savecurrent=false}
...
C {ip/comparators/comp_p/comp_p_pex.sym} -90 0 0 0 {name=X1}
C {devices/code.sym} -390 -190 0 0 {name=INCLUDES only_toplevel=false value=
"
.include ~/projects/tt06_555/xsch/ip/comparators/comp_p/comp_p_pex.spice
"}
