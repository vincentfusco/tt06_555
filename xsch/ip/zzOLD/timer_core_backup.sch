...
spiceprefix=X
mult=1}
C {ip/logic/sr_latch.sym} 350 -10 0 0 {name=I_SR_LATCH}
...
C {ip/logic/inv.sym} 560 -50 0 0 {name=I_INV1}
C {ip/logic/inv.sym} 740 -50 0 0 {name=I_INV2[1:0]}
C {ip/logic/inv.sym} 920 -50 0 0 {name=I_INV3[3:0]}
...
C {ip/comp_n.sym} 0 -110 0 0 {name=I_COMP_N}
...
C {ip/comp_p.sym} 0 170 0 0 {name=I_COMP_P}
